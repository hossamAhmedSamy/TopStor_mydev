...
docker run -d -v /$pool/$vol:/$pool/$vol -v /etc/exports.$vol:/etc/exports:ro --cap-add SYS_ADMIN -p $ipaddr:2049:2049  -p $ipaddr:2049:2049/udp  -p $ipaddr:32765:32765 -p $ipaddr:32765:32765/udp -p $ipaddr:111:111 -p $ipaddr:111:111/udp -p $ipaddr:32767:32767 -p $ipaddr:32767:32767/udp --name nfs-$pool-$vol 10.11.11.124:5000/nfs
